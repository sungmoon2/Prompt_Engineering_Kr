"""
Information_organization 실습 모듈

Part 2 - 섹션 2.2.3 실습 코드: 기본 프롬프트와 향상된 프롬프트의 차이 비교
"""
...
# from utils.prompt_templates import get_basic_information_organization_prompt, get_enhanced_information_organization_prompt

def main():
    """메인 함수"""
    print_header(f"Information_organization")
