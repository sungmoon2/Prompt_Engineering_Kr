"""
Data_validation 실습 모듈

Part 2 - 섹션 2.2.2 실습 코드: 기본 프롬프트와 향상된 프롬프트의 차이 비교
"""
...
# from utils.prompt_templates import get_basic_data_validation_prompt, get_enhanced_data_validation_prompt

def main():
    """메인 함수"""
    print_header(f"Data_validation")
