"""
Complex_task_decomposition 실습 모듈

Part 2 - 섹션 2.4 실습 코드: 기본 프롬프트와 향상된 프롬프트의 차이 비교
"""
...
# from utils.prompt_templates import get_basic_complex_task_decomposition_prompt, get_enhanced_complex_task_decomposition_prompt

def main():
    """메인 함수"""
    print_header(f"Complex_task_decomposition")
