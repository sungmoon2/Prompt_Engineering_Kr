"""
Sustainable_learning 실습 모듈

Part 9 - 섹션 9.3 실습 코드: 기본 프롬프트와 향상된 프롬프트의 차이 비교
"""
...
# from utils.prompt_templates import get_basic_sustainable_learning_prompt, get_enhanced_sustainable_learning_prompt

def main():
    """메인 함수"""
    print_header(f"Sustainable_learning")
