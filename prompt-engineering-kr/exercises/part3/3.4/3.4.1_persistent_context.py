"""
Persistent_context 실습 모듈

Part 3 - 섹션 3.4.1 실습 코드: 기본 프롬프트와 향상된 프롬프트의 차이 비교
"""
...
# from utils.prompt_templates import get_basic_persistent_context_prompt, get_enhanced_persistent_context_prompt

def main():
    """메인 함수"""
    print_header(f"Persistent_context")
