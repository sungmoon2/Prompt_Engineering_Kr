"""
Compression_techniques 실습 모듈

Part 3 - 섹션 3.1.1 실습 코드: 기본 프롬프트와 향상된 프롬프트의 차이 비교
"""
...
# from utils.prompt_templates import get_basic_compression_techniques_prompt, get_enhanced_compression_techniques_prompt

def main():
    """메인 함수"""
    print_header(f"Compression_techniques")
