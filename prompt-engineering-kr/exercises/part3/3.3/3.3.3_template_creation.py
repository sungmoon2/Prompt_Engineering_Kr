"""
Template_creation 실습 모듈

Part 3 - 섹션 3.3.3 실습 코드: 기본 프롬프트와 향상된 프롬프트의 차이 비교
"""
...
# from utils.prompt_templates import get_basic_template_creation_prompt, get_enhanced_template_creation_prompt

def main():
    """메인 함수"""
    print_header(f"Template_creation")
