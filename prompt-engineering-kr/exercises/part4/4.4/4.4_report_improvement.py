"""
Report_improvement 실습 모듈

Part 4 - 섹션 4.4 실습 코드: 기본 프롬프트와 향상된 프롬프트의 차이 비교
"""
...
# from utils.prompt_templates import get_basic_report_improvement_prompt, get_enhanced_report_improvement_prompt

def main():
    """메인 함수"""
    print_header(f"Report_improvement")
