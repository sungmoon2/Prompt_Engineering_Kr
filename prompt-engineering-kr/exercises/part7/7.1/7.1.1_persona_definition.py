"""
Persona_definition 실습 모듈

Part 7 - 섹션 7.1.1 실습 코드: 기본 프롬프트와 향상된 프롬프트의 차이 비교
"""
...
# from utils.prompt_templates import get_basic_persona_definition_prompt, get_enhanced_persona_definition_prompt

def main():
    """메인 함수"""
    print_header(f"Persona_definition")
