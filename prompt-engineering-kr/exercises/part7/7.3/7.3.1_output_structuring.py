"""
Output_structuring 실습 모듈

Part 7 - 섹션 7.3.1 실습 코드: 기본 프롬프트와 향상된 프롬프트의 차이 비교
"""
...
# from utils.prompt_templates import get_basic_output_structuring_prompt, get_enhanced_output_structuring_prompt

def main():
    """메인 함수"""
    print_header(f"Output_structuring")
