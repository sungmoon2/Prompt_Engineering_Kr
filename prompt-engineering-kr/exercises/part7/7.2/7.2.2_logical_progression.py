"""
Logical_progression 실습 모듈

Part 7 - 섹션 7.2.2 실습 코드: 기본 프롬프트와 향상된 프롬프트의 차이 비교
"""
...
# from utils.prompt_templates import get_basic_logical_progression_prompt, get_enhanced_logical_progression_prompt

def main():
    """메인 함수"""
    print_header(f"Logical_progression")
