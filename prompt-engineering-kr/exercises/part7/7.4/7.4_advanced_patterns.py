"""
Advanced_patterns 실습 모듈

Part 7 - 섹션 7.4 실습 코드: 기본 프롬프트와 향상된 프롬프트의 차이 비교
"""
...
# from utils.prompt_templates import get_basic_advanced_patterns_prompt, get_enhanced_advanced_patterns_prompt

def main():
    """메인 함수"""
    print_header(f"Advanced_patterns")
