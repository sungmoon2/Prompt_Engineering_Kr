"""
Follow_up_questions 실습 모듈

Part 1 - 섹션 1.3.2 실습 코드: 기본 프롬프트와 향상된 프롬프트의 차이 비교
"""
...
# from utils.prompt_templates import get_basic_follow_up_questions_prompt, get_enhanced_follow_up_questions_prompt

def main():
    """메인 함수"""
    print_header(f"Follow_up_questions")
