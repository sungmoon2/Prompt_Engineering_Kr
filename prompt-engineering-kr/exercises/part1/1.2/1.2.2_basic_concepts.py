"""
Basic_concepts 실습 모듈

Part 1 - 섹션 1.2.2 실습 코드: 기본 프롬프트와 향상된 프롬프트의 차이 비교
"""
...
# from utils.prompt_templates import get_basic_basic_concepts_prompt, get_enhanced_basic_concepts_prompt

def main():
    """메인 함수"""
    print_header(f"Basic_concepts")
