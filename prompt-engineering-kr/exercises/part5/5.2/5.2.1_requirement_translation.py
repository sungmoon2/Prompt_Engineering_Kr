"""
Requirement_translation 실습 모듈

Part 5 - 섹션 5.2.1 실습 코드: 기본 프롬프트와 향상된 프롬프트의 차이 비교
"""
...
# from utils.prompt_templates import get_basic_requirement_translation_prompt, get_enhanced_requirement_translation_prompt

def main():
    """메인 함수"""
    print_header(f"Requirement_translation")
