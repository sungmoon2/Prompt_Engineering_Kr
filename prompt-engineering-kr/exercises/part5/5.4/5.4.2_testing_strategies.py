"""
Testing_strategies 실습 모듈

Part 5 - 섹션 5.4.2 실습 코드: 기본 프롬프트와 향상된 프롬프트의 차이 비교
"""
...
# from utils.prompt_templates import get_basic_testing_strategies_prompt, get_enhanced_testing_strategies_prompt

def main():
    """메인 함수"""
    print_header(f"Testing_strategies")
