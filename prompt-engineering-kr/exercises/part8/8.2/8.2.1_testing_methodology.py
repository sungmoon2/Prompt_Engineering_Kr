"""
Testing_methodology 실습 모듈

Part 8 - 섹션 8.2.1 실습 코드: 기본 프롬프트와 향상된 프롬프트의 차이 비교
"""
...
# from utils.prompt_templates import get_basic_testing_methodology_prompt, get_enhanced_testing_methodology_prompt

def main():
    """메인 함수"""
    print_header(f"Testing_methodology")
