"""
Domain_concepts 실습 모듈

Part 6 - 섹션 6.1.2 실습 코드: 기본 프롬프트와 향상된 프롬프트의 차이 비교
"""
...
# from utils.prompt_templates import get_basic_domain_concepts_prompt, get_enhanced_domain_concepts_prompt

def main():
    """메인 함수"""
    print_header(f"Domain_concepts")
