"""
Cross_domain_approaches 실습 모듈

Part 6 - 섹션 6.4.1 실습 코드: 기본 프롬프트와 향상된 프롬프트의 차이 비교
"""
...
# from utils.prompt_templates import get_basic_cross_domain_approaches_prompt, get_enhanced_cross_domain_approaches_prompt

def main():
    """메인 함수"""
    print_header(f"Cross_domain_approaches")
