"""
Multidisciplinary_exploration 실습 모듈

Part 6 - 섹션 6.4 실습 코드: 기본 프롬프트와 향상된 프롬프트의 차이 비교
"""
...
# from utils.prompt_templates import get_basic_multidisciplinary_exploration_prompt, get_enhanced_multidisciplinary_exploration_prompt

def main():
    """메인 함수"""
    print_header(f"Multidisciplinary_exploration")
