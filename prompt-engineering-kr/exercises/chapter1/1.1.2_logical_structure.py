...
"""
    ...
    # 향상된 프롬프트
    enhanced_prompt = f"""
당신은 학술 출판 편집자로서 수천 개의 논문과 리포트 구조를 검토하고 개선했습니다.

다음 주제와 논점을 바탕으로 세부적인 리포트 구조를 설계해주세요:

주제: {topic}
주요 논점: {key_points}
리포트 유형: {report_type}
목적: 학술적 우수성과 논리적 일관성 확보

다음 내용을 포함해주세요:
1. 전체 리포트의 세부 구조 (모든 섹션과 하위 섹션 포함)
2. 각 섹션의 구체적인 목적과 포함되어야 할 내용
3. 논점 간의 연결성과 전체적인 일관성을 강화할 방법
4. 서론에서 독자의 관심을 끌고 주제의 중요성을 효과적으로 전달하는 방법
5. 각 섹션에서 학술적 논증을 강화하기 위한 증거와 인용 활용 방법
6. 결론에서 연구의 함의와 중요성을 강조하는 방법
7. 독자가 주요 내용을 쉽게 파악할 수 있게 하는 시각적/구조적 요소 제안
