...
Part 0 - 섹션 0.1.1 실습 코드: 기본 프롬프트와 향상된 프롬프트의 차이 비교
"""
...
# from utils.prompt_templates import get_basic_basic_prompts_prompt, get_enhanced_basic_prompts_prompt

def main():
    """메인 함수"""
    print_header(f"Basic_prompts")
