...
Part 0 - 섹션 0.3.2 실습 코드: 기본 프롬프트와 향상된 프롬프트의 차이 비교
"""
...
# from utils.prompt_templates import get_basic_usage_tips_prompt, get_enhanced_usage_tips_prompt

def main():
    """메인 함수"""
    print_header(f"Usage_tips")
